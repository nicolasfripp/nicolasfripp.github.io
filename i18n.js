(function() {
  var translations = {
    ...
    "about.bio3": {
      es: "Este sitio web, vinculado a mi repositorio en GitHub, tiene como objetivo difundir y poner a disposici\u00f3n los principales proyectos que desarroll\u00e9 durante la especializaci\u00f3n, los cuales representan los aprendizajes, competencias y desaf\u00edos m\u00e1s significativos de mi recorrido acad\u00e9mico. Tambi\u00e9n incluye algunos proyectos personales. Actualmente me desempe\u00f1o como Full Stack Engineer, con experiencia tanto en Frontend como en Backend, y he trabajado en proyectos que integran Inteligencia Artificial Generativa (GenAI). Para conocer m\u00e1s sobre mi trayectoria profesional actual, pueden consultar mi perfil de LinkedIn.",
      en: "This website, linked to my GitHub repository, aims to share and make available the main projects I developed during the specialization, which represent the most significant learnings, competencies, and challenges of my academic journey. It also includes some personal projects. I currently work as a Full Stack Engineer, with experience in both Frontend and Backend, and I have worked on projects integrating Generative AI (GenAI). To learn more about my current professional career, you can visit my LinkedIn profile."
    },
    "projects.title": {
